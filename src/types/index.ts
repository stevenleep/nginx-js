...
export interface PluginLifecycle {
  ...
  onError?(
    context: RequestContext,
    error: Error
  ): Error | Promise<Error> | void;
  onComplete?(context: RequestContext, response?: ResponseContext): void | Promise<void>;
  beforeWebSocketOpen?(context: WebSocketRequestContext): WebSocketRequestContext | Promise<WebSocketRequestContext> | void;
...
export interface HttpInterceptorConfig extends BaseInterceptorConfig {
  ...
  onAfterResponse?: (context: RequestContext, response: ResponseContext) => ResponseContext | Promise<ResponseContext> | void;
...
export interface WebSocketInterceptorConfig extends BaseInterceptorConfig {
  onBeforeWebSocketOpen?: (context: WebSocketRequestContext) => WebSocketRequestContext | Promise<WebSocketRequestContext> | void;
  onWebSocketOpen?: (context: WebSocketRequestContext, event: Event) => void | Promise<void>;
  onBeforeWebSocketSend?: (context: WebSocketRequestContext, message: WebSocketMessageContext) => any | Promise<any> | void;
  onWebSocketMessage?: (context: WebSocketRequestContext, message: WebSocketMessageContext, event: MessageEvent) => void | Promise<void>;
  onWebSocketError?: (context: WebSocketRequestContext, event: Event) => void | Promise<void>;
  onWebSocketClose?: (context: WebSocketRequestContext, event: CloseEvent) => void | Promise<void>;
}
