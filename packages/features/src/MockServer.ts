...
export interface MockRule {
  ...
  response: unknown | ((context: RequestContext) => unknown | Promise<unknown>);
  delay?: number;
  status?: number;
...
export class MockServer {
  ...
  private _matchMethod(contextMethod: string | undefined, ruleMethod: string | string[]): boolean {
...
export class MockGenerator {
  ...
  static pagination<T>(items: T[], page: number = 1, pageSize: number = 10) {
